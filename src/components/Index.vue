...
.slide1 {
  background-image: url(~assets/images/escuela1.jpg);
}

.slide2 {
  background-image: url(~assets/images/escuela2.jpg);
}

.slide3 {
  background-image: url(~assets/images/escuela3.jpg);
}
.card-noticias {
  /* width: 70em;*/
  margin: 0 auto;
